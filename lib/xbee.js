...
/**
 * XBMQ XBee Factory.  Creates a new instance of {@XBee}
 ...
 */
XBee.prototype.transmit = function (frame, timeout) {
  if (!frame) {
    return q.reject(TypeError('Invalid frame.'))
  }
  ...
  // send the request
  self.serialport.write(self.xbeeAPI.buildFrame(frame), function (err) {
    if (err) {
