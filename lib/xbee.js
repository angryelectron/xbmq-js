 ...
 */
  static create (config) {
    ...
    const xbeeAPI = new XBeeAPI.XBeeAPI({ api_mode: config.apiMode })
    return new Promise((resolve, reject) => {
      const serialport = new SerialPort({ path: config.port, baudRate: config.baud })
 ...
 */
  sendAndReceiveFrame (frame, timeout) {
    ...
    return new Promise((resolve, reject) => {
      ...
      const matchFrameResponse = (receivedFrame) => {
